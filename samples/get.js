...
/* get data */
vectorExpress.get( 'https://vector.express/api/v2/public/convert/svg/auto/pdf/' )
.then( ( res ) =>
{
  console.log( res );
  /*
...
vectorExpress.get( 'https://vector.express/api/v2/public/convert/svg/auto/pdf/', 'full' )
.then( res => {
  console.log( res )
});
